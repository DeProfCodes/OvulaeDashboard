const countries = [
    ...
    { name: "England", code: "+44", flag: "https://flagcdn.com/w40/gb-eng.png" },
    ...
    { name: "Congo (Congo-Brazzaville)", code: "+242", flag: "https://flagcdn.com/w40/cg.png" },
    { name: "Congo (DRC)", code: "+243", flag: "https://flagcdn.com/w40/cd.png" },
    ...
    // Continue with the remaining countries
    ...
    { name: "Timor-Leste", code: "+670", flag: "https://flagcdn.com/w40/tl.png" },
...
function loadCountryDropdown()
{
	...
	countries.forEach((country) =>
	{
		...
		listItem.innerHTML = `
            <img src="${country.flag}" alt="${country.name}" style="width: 20px; height: 14px; margin-right: 10px;" />
...
{
	$("#selectedFlag").attr("src", country.flag);
...
document.addEventListener("DOMContentLoaded", loadCountryDropdown);