...
function TogglePasswordMask()
{
	...
	var passInput2 = document.getElementById('psw-input-2');
	if (passInput) 
	{
		...
		if (isPass)
		{
			$(".pass-eye").removeClass("bi-eye");
			$(".pass-eye").addClass("bi-eye-slash");
		}
		else
		{
			$(".pass-eye").addClass("bi-eye");
			$(".pass-eye").removeClass("bi-eye-slash");
		}
	}
	if (passInput2) 
	{
		var isPass = (passInput2.type === 'password');
